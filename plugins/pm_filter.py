...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("Hᴏᴡ ᴛᴏ Dᴏᴡɴʟᴏᴀᴅ Fʀᴏᴍ Uʀʟsᴏᴘᴇɴ⚡", url=f"https://t.me/{temp.U_NAME}")
    ])
    try:
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Kgashok04")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("Hᴏᴡ ᴛᴏ Dᴏᴡɴʟᴏᴀᴅ Fʀᴏᴍ Uʀʟsᴏᴘᴇɴ⚡", url=f"https://t.me/TeamHMT_8")
    ])
